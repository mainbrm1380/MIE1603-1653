...
def main():
    classes = {"industrial": {"S":10,"C":25,"L":5,"min_s_in_c":1,"max_s_in_c":5,"min_l_per_s":1,"max_l_per_s":5}, 
    ...
    data = generate_data_set(classes, 3)
    with open("data.json","w") as f:
        json.dump(data,f)
    
main()

#"toy": {"S":5,"C":5,"L":5,"min_s_in_c":1,"max_s_in_c":5,"min_l_per_s":1,"max_l_per_s":5},